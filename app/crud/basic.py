...
from app.models.model import BGBModel as DBModel


def insert(db: Session, model_cls: DBModel, schema_cls: PySchema) -> None:
    """
    ## 데이터 단건 생성
    """
...
def update(db: Session, model_cls: DBModel, schema_cls: PySchema) -> PySchema:
    """
    ## 데이터 단건 수정
    """
...
def delete(db: Session, model_cls: DBModel, schema_cls: PySchema) -> None:
    """
    ## 데이터 단건 삭제
    """
