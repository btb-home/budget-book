...
class UserSessionData(BaseModel, Generic[T]):
    ...
    def create(user_info: BaseModel) -> "UserSessionData":
        ...
        return UserSessionData(
            ...
            expire_time=timedelta(minutes=AppConfig.SESSION_EXPIRE_MINUTES),  # 설정된 SESSION_EXPIRE_MINUTES를 만료 시간으로 설정
    ...
    def get_remaining_time(self) -> int:
        ...
        remaining_time = (self.last_session_dttm + self.expire_time - datetime.now()).total_seconds()
