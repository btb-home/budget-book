...
from app.schemas.users.accounts import (
    UserAccountBase,
    UserAccountReq,
    UserAccountRes,
    UserCheckIn,
...
from app.services.commands.login_session import check_session, create_session
from app.utils.database.basic import insert, select_one
from app.utils.database.decorator import connectional, transactional
...
async def auth(
    ...
    """
    data = select_one(db_session, UserAccount, UserAccountRes)(
        query={
...
async def sign_out(
    ...
    """
    res = insert(db_session, UserAccount, UserAccountBase)(
